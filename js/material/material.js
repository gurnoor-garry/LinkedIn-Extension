...
/**
   ...
   */
let MaterialButton = function MaterialButton(element) {
...
/**
   ...
   * @param {HTMLElement} element The element that will be upgraded.
   */
let MaterialCheckbox = function MaterialCheckbox(element) {
    this.element_ = element;
    // Initialize instance.
    this.init();
};
...
/**
   ...
   * @param {HTMLElement} element The element that will be upgraded.
   */
let MaterialIconToggle = function MaterialIconToggle(element) {
    this.element_ = element;
    // Initialize instance.
    this.init();
};
...
/**
   ...
   * @param {HTMLElement} element The element that will be upgraded.
   */
let MaterialMenu = function MaterialMenu(element) {
    this.element_ = element;
    // Initialize instance.
    this.init();
};
...
MaterialMenu.prototype.init = function () {
    if (this.element_) {
        ...
        let forElId = this.element_.getAttribute('for') || this.element_.getAttribute('data-mdl-for');
        let forEl = null;
        if (forElId) {
...
MaterialMenu.prototype.handleForKeyboardEvent_ = function (evt) {
    if (this.element_ && this.container_ && this.forElement_) {
        let items = this.element_.querySelectorAll('.' + this.CssClasses_.ITEM + ':not([disabled])');
...
MaterialMenu.prototype.show = function (evt) {
    if (this.element_ && this.container_ && this.outline_) {
        ...
        let transitionDuration = this.Constant_.TRANSITION_DURATION_SECONDS * this.Constant_.TRANSITION_DURATION_FRACTION;
...
/**
   ...
   * @param {HTMLElement} element The element that will be upgraded.
   */
let MaterialProgress = function MaterialProgress(element) {
    this.element_ = element;
    // Initialize instance.
    this.init();
};
...
/**
   ...
   * @param {HTMLElement} element The element that will be upgraded.
   */
let MaterialRadio = function MaterialRadio(element) {
    this.element_ = element;
    // Initialize instance.
    this.init();
};
...
/**
   ...
   * @param {HTMLElement} element The element that will be upgraded.
   */
let MaterialSlider = function MaterialSlider(element) {
    this.element_ = element;
...
MaterialSlider.prototype.init = function () {
    if (this.element_) {
        if (this.isIE_) {
            ...
            this.element_.parentElement.removeChild(this.element_);
            container.appendChild(this.element_);
            let backgroundFlex = document.createElement('div');
...
/**
   ...
   * @constructor
   */
let MaterialSpinner = function MaterialSpinner(element) {
    this.element_ = element;
    // Initialize instance.
    this.init();
};
...
/**
   ...
   * @param {HTMLElement} element The element that will be upgraded.
   */
let MaterialSwitch = function MaterialSwitch(element) {
    this.element_ = element;
    // Initialize instance.
    this.init();
};
...
/**
   ...
   */
let MaterialTabs = function MaterialTabs(element) {
...
/**
   ...
   * @param {HTMLElement} element The element that will be upgraded.
   */
let MaterialTextfield = function MaterialTextfield(element) {
    this.element_ = element;
...
MaterialTextfield.prototype.init = function () {
    if (this.element_) {
        ...
        if (this.input_) {
            ...
            let invalid = this.element_.classList.contains(this.CssClasses_.IS_INVALID);
            this.updateClasses_();
            this.element_.classList.add(this.CssClasses_.IS_UPGRADED);
            if (invalid) {
                this.element_.classList.add(this.CssClasses_.IS_INVALID);
...
/**
   ...
   * @param {HTMLElement} element The element that will be upgraded.
   */
let MaterialTooltip = function MaterialTooltip(element) {
    this.element_ = element;
    // Initialize instance.
    this.init();
};
...
/**
   ...
   * @param {HTMLElement} element The element that will be upgraded.
   */
let MaterialLayout = function MaterialLayout(element) {
    this.element_ = element;
    // Initialize instance.
    this.init();
};
...
MaterialLayout.prototype.contentScrollHandler_ = function () {
    ...
    let headerVisible = !this.element_.classList.contains(this.CssClasses_.IS_SMALL_SCREEN) || this.element_.classList.contains(this.CssClasses_.FIXED_HEADER);
...
MaterialLayout.prototype.init = function () {
    if (this.element_) {
        let container = document.createElement('div');
        container.classList.add(this.CssClasses_.CONTAINER);
        let focusedElement = this.element_.querySelector(':focus');
        this.element_.parentElement.insertBefore(container, this.element_);
        this.element_.parentElement.removeChild(this.element_);
        container.appendChild(this.element_);
        if (focusedElement) {
        ...
        let directChildren = this.element_.childNodes;
        let numChildren = directChildren.length;
        for (let c = 0; c < numChildren; c++) {
            let child = directChildren[c];
        ...
        if (this.drawer_) {
            ...
            if (!drawerButton) {
                ...
                let drawerButtonIcon = document.createElement('i');
        ...
        if (this.header_ && this.tabBar_) {
            ...
            // Select element tabs, document panels
            let tabs = this.tabBar_.querySelectorAll('.' + this.CssClasses_.TAB);
            let panels = this.content_.querySelectorAll('.' + this.CssClasses_.PANEL);
            // Create new tabs for each tab element
...
function MaterialLayoutTab(tab, tabs, panels, layout) {
    ...
    function selectTab() {
        let href = tab.href.split('#')[1];
        let panel = layout.content_.querySelector('#' + href);
...
/**
   ...
   * @param {Element} element The element that will be upgraded.
   */
let MaterialDataTable = function MaterialDataTable(element) {
    this.element_ = element;
    // Initialize instance.
    this.init();
};
...
MaterialDataTable.prototype.init = function () {
    if (this.element_) {
        let firstHeader = this.element_.querySelector('th');
        let bodyRows = Array.prototype.slice.call(this.element_.querySelectorAll('tbody tr'));
        let footRows = Array.prototype.slice.call(this.element_.querySelectorAll('tfoot tr'));
        let rows = bodyRows.concat(footRows);
        if (this.element_.classList.contains(this.CssClasses_.SELECTABLE)) {
            let th = document.createElement('th');
            let headerCheckbox = this.createCheckbox_(null, rows);
            ...
            for (let i = 0; i < rows.length; i++) {
                ...
                if (firstCell) {
                    ...
                    if (rows[i].parentNode.nodeName.toUpperCase() === 'TBODY') {
                        let rowCheckbox = this.createCheckbox_(rows[i]);
...
/**
   ...
   * @param {HTMLElement} element The element that will be upgraded.
   */
let MaterialRipple = function MaterialRipple(element) {
    this.element_ = element;
    // Initialize instance.
    this.init();
};
