...
!(function () {
  ...
  (s = (function () {
    ...
    function t(e) {
      let t = e.getAttribute("data-upgraded");
    ...
    function n(t, s) {
      if ("undefined" == typeof t && "undefined" == typeof s)
        for (let i = 0; i < c.length; i++) n(c[i].className, c[i].cssClass);
      else {
        let l = t;
        ...
        for (
          let r = document.querySelectorAll("." + s), _ = 0;
          _ < r.length;
          _++
        )
          a(r[_], l);
    ...
    function a(n, a) {
      ...
      let l = i("mdl-componentupgrading", !0, !0);
      if ((n.dispatchEvent(l), !l.defaultPrevented)) {
        ...
        for (let d, h = 0, u = r.length; h < u; h++) {
          if (((d = r[h]), !d))
            throw new Error(
              "Unable to find a registered component for the given class."
            );
          o.push(d.className), n.setAttribute("data-upgraded", o.join(","));
          let E = new d.classConstructor(n);
          (E[C] = d), p.push(E);
          for (let m = 0, L = d.callbacks.length; m < L; m++) d.callbacks[m](n);
          d.widget && (n[d.className] = E);
          let I = i("mdl-componentupgraded", !0, !1);
          n.dispatchEvent(I);
        }
      }
    }
    function l(e) {
      ...
      for (let t, s = 0, i = e.length; s < i; s++)
        (t = e[s]),
          t instanceof HTMLElement &&
            (a(t), t.children.length > 0 && l(t.children));
    }
    function o(t) {
      let s = "undefined" == typeof t.widget && "undefined" == typeof t.widget,
        i = !0;
    ...
    function _() {
      for (let e = 0; e < c.length; e++) n(c[e].className);
    }
    function d(e) {
      if (e) {
        let t = p.indexOf(e);
        p.splice(t, 1);
        let s = e.element_.getAttribute("data-upgraded").split(","),
          n = s.indexOf(e[C].classAsString);
        s.splice(n, 1), e.element_.setAttribute("data-upgraded", s.join(","));
        let a = i("mdl-componentdowngraded", !0, !1);
  ...
  (window.MaterialMenu = d),
    ...
    (d.prototype.init = function () {
      if (this.element_) {
        ...
        let n = this.element_.querySelectorAll("." + this.CssClasses_.ITEM);
    ...
    (d.prototype.handleForKeyboardEvent_ = function (e) {
      if (this.element_ && this.container_ && this.forElement_) {
        let t = this.element_.querySelectorAll(
    ...
    (d.prototype.hide = function () {
      if (this.element_ && this.container_ && this.outline_) {
        for (
          let e = this.element_.querySelectorAll("." + this.CssClasses_.ITEM),
            t = 0;
          t < e.length;
          t++
        )
          e[t].style.removeProperty("transition-delay");
        let s = this.element_.getBoundingClientRect(),
          i = s.height,
          n = s.width;
        this.element_.classList.add(this.CssClasses_.IS_ANIMATING),
          this.applyClip_(i, n),
  ...
  (window.MaterialRadio = c),
    ...
    (c.prototype.onChange_ = function (e) {
      for (
        let t = document.getElementsByClassName(this.CssClasses_.JS_RADIO),
          s = 0;
        s < t.length;
        s++
      ) {
  ...
  (window.MaterialSpinner = u),
    ...
    (u.prototype.init = function () {
      if (this.element_) {
        for (let e = 1; e <= this.Constant_.MDL_SPINNER_LAYER_COUNT; e++)
          this.createLayer(e);
        this.element_.classList.add("is-upgraded");
      }
    }),
  ...
  (window.MaterialTextfield = L),
    ...
    (L.prototype.init = function () {
      if (
        ...
        let e = this.element_.classList.contains(this.CssClasses_.IS_INVALID);
        this.updateClasses_(),
          this.element_.classList.add(this.CssClasses_.IS_UPGRADED),
  ...
  (window.MaterialLayout = f),
    ...
    (f.prototype.toggleDrawer = function () {
      let e = this.element_.querySelector("." + this.CssClasses_.DRAWER_BTN);
    ...
    (f.prototype.init = function () {
      if (this.element_) {
        let e = document.createElement("div");
        e.classList.add(this.CssClasses_.CONTAINER);
        let s = this.element_.querySelector(":focus");
        this.element_.parentElement.insertBefore(e, this.element_),
          this.element_.parentElement.removeChild(this.element_),
          e.appendChild(this.element_),
          s && s.focus();
        for (
          let i = this.element_.childNodes, n = i.length, a = 0;
          a < n;
          a++
        ) {
          let l = i[a];
        ...
        if (
          ...
          let r = this.element_.querySelector(
        ...
        if (
          ...
          for (
            let L = this.tabBar_.querySelectorAll("." + this.CssClasses_.TAB),
      ...
      if (this.element_) {
        ...
        if (this.element_.classList.contains(this.CssClasses_.SELECTABLE)) {
          ...
          for (let l = 0; l < i.length; l++) {
            let o = i[l].querySelector("td");
            if (o) {
              let r = document.createElement("td");
              if ("TBODY" === i[l].parentNode.nodeName.toUpperCase()) {
                let _ = this.createCheckbox_(i[l]);
                r.appendChild(_);
              }
  ...
  (window.MaterialRipple = S),
    ...
    (S.prototype.downHandler_ = function (e) {
      ...
      if (
        ...
        if (0 === e.clientX && 0 === e.clientY)
          ...
          let l = void 0 !== e.clientX ? e.clientX : e.touches[0].clientX,
    ...
    (S.prototype.init = function () {
      if (this.element_) {
        let e = this.element_.classList.contains(
          this.CssClasses_.RIPPLE_CENTER
        );
